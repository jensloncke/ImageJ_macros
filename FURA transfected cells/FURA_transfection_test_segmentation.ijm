...
imageCalculator("add create stack", measurement_title_340, measurement_title_380);
run("Z Project...", "projection=[Sum Slices]");
run("Find Maxima...", "prominence=50000 output=[Segmented Particles]");
segmented = getTitle();
imageCalculator("AND create", thresholded, segmented);
